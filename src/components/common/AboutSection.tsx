            ...
            <div className="container-custom">
                ...
                <div className="max-w-6xl mx-auto space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div
                            ref={row1Image.ref}
                            className={`relative h-[400px] slide-in-right ${row1Image.isInView ? 'in-view' : ''}`}
                        >
                            <Image
                                src="/About-1.jpg"
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        <div
                            ref={row2Image.ref}
                            className={`relative h-[400px] slide-in-left ${row2Image.isInView ? 'in-view' : ''}`}
                        >
                            <Image
                                src="/About-2.jpg"
                        ...
                        <div
                            ref={row2Content.ref}
                            className={`slide-in-right ${row2Content.isInView ? 'in-view' : ''}`}
                        >
